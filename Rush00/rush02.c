...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/05 10:33:59 by kmendes-          #+#    #+#             */
/*   Updated: 2022/02/05 10:34:06 by kmendes-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (current_line == 1 && (current_index == 1 || current_index == length))
		ft_putchar('A');
	else if (current_line == height
